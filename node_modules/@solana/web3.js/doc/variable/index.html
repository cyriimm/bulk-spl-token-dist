    ...
    <td>
      <div>
        <p>
          ...
          <span class="code" data-ice="name"><span><a href="variable/index.html#static-variable-DESTROY_TIMEOUT_MS">DESTROY_TIMEOUT_MS</a></span></span><span class="code" data-ice="signature">: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></span>
        </p>
      </div>
      <div>
    ...
    <td>
      <div>
        <p>
          ...
          <span class="code" data-ice="name"><span><a href="variable/index.html#static-variable-MAX_SEED_LENGTH">MAX_SEED_LENGTH</a></span></span><span class="code" data-ice="signature">: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></span>
        </p>
      </div>
      <div>
        
        
        <div data-ice="description"><p>Maximum length of derived pubkey seed</p>
</div>
      </div>
    </td>
    <td>
    ...
    <td>
      <div>
        <p>
          ...
          <span class="code" data-ice="name"><span><a href="variable/index.html#static-variable-SYSVAR_INSTRUCTIONS_PUBKEY">SYSVAR_INSTRUCTIONS_PUBKEY</a></span></span><span class="code" data-ice="signature">: <span><a href="class/src/publickey.js~PublicKey.html">PublicKey</a></span></span>
        </p>
      </div>
      <div>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-variable-BLOCKHASH_CACHE_TIMEOUT_MS">
    ...
    <span class="right-info">
      ...
      <span data-ice="source"><span><a href="file/src/connection.js.html#lineNumber26">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {BLOCKHASH_CACHE_TIMEOUT_MS} from &apos;<span><a href="file/src/connection.js.html#lineNumber26">@solana/web3</a></span>&apos;</code></pre></div>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-variable-DESTROY_TIMEOUT_MS">
    <span class="access" data-ice="access">public</span>
    ...
    <span class="code" data-ice="name">DESTROY_TIMEOUT_MS</span><span class="code" data-ice="signature">: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/agent-manager.js.html#lineNumber6">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {DESTROY_TIMEOUT_MS} from &apos;<span><a href="file/src/agent-manager.js.html#lineNumber6">@solana/web3</a></span>&apos;</code></pre></div>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-variable-GetConfirmedBlockRpcResult">
    ...
    <span class="right-info">
      ...
      <span data-ice="source"><span><a href="file/src/connection.js.html#lineNumber1223">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {GetConfirmedBlockRpcResult} from &apos;<span><a href="file/src/connection.js.html#lineNumber1223">@solana/web3</a></span>&apos;</code></pre></div>
...
<div class="detail" data-ice="detail">
  ...
  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {LAMPORTS_PER_SOL} from &apos;<span><a href="file/src/index.js.html#lineNumber42">@solana/web3</a></span>&apos;</code></pre></div>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-variable-MAX_SEED_LENGTH">
    <span class="access" data-ice="access">public</span>
    ...
    <span class="code" data-ice="name">MAX_SEED_LENGTH</span><span class="code" data-ice="signature">: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></span>
    <span class="right-info">
  ...
  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {MAX_SEED_LENGTH} from &apos;<span><a href="file/src/publickey.js.html#lineNumber16">@solana/web3</a></span>&apos;</code></pre></div>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-variable-SYSVAR_INSTRUCTIONS_PUBKEY">
    <span class="access" data-ice="access">public</span>
    ...
    <span class="code" data-ice="name">SYSVAR_INSTRUCTIONS_PUBKEY</span><span class="code" data-ice="signature">: <span><a href="class/src/publickey.js~PublicKey.html">PublicKey</a></span></span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/sysvar.js.html#lineNumber24">source</a></span></span>
    </span>
  </h3>

  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {SYSVAR_INSTRUCTIONS_PUBKEY} from &apos;<span><a href="file/src/sysvar.js.html#lineNumber24">@solana/web3</a></span>&apos;</code></pre></div>
